...
function generate(ts, compilerOptions, sourceLang, templateAst, hasScriptSetup, cssScopedClasses = [], htmlToTemplate, searchTexts) {
    ...
    for (const tagName in tagOffsetsMap) {
        ...
        const var_componentVar = (0, shared_1.capitalize)((0, shared_1.camelize)(tagName.replace(/:/g, '-')));
        ...
        const name2 = isIntrinsicElement(compilerOptions.experimentalRuntimeMode, tagName) ? tagName : (0, shared_1.camelize)(tagName); // helloWorld
        const name3 = isIntrinsicElement(compilerOptions.experimentalRuntimeMode, tagName) ? tagName : (0, shared_1.capitalize)(name2); // HelloWorld
        ...
        tagResolves[tagName] = {
            ...
            emit: var_emit,
            offsets: tagOffsets.map(offset => { var _a; return (_a = htmlToTemplate({ start: offset, end: offset })) === null || _a === void 0 ? void 0 : _a.start; }).filter(notEmpty),
        };
    }
    ...
    function visitElementNode(node, parentEl) {
        ...
        tsCodeGen.addText(`{\n`);
        {
            ...
            const tagText = (_b = (_a = tagResolves[node.tag]) === null || _a === void 0 ? void 0 : _a.component) !== null && _b !== void 0 ? _b : node.tag;
            const fullTagStart = tsCodeGen.getText().length;
            const tagCapabilities = Object.assign(Object.assign(Object.assign({}, capabilitiesSet.diagnosticOnly), capabilitiesSet.tagHover), (_isIntrinsicElement ? Object.assign({}, capabilitiesSet.tagReference) : {}));
            ...
            for (const varName of slotBlockVars)
                localVars[varName] = ((_c = localVars[varName]) !== null && _c !== void 0 ? _c : 0) + 1;
    ...
    function writeProps(node, forRemainStyleOrClass, mode) {
        ...
        for (const prop of node.props) {
            if (prop.type === 7 /* CompilerDOM.NodeTypes.DIRECTIVE */
                ...
                else if (((_c = prop.exp) === null || _c === void 0 ? void 0 : _c.constType) === 3 /* CompilerDOM.ConstantTypes.CAN_STRINGIFY */) {
                ...
                && prop.name === 'bind'
                && !prop.arg
                && ((_d = prop.exp) === null || _d === void 0 ? void 0 : _d.type) === 4 /* CompilerDOM.NodeTypes.SIMPLE_EXPRESSION */) {
    ...
    function writeInlineCss(node) {
        ...
        for (const prop of node.props) {
            if (prop.type === 7 /* CompilerDOM.NodeTypes.DIRECTIVE */
                ...
                const newStart = (_c = htmlToTemplate({ start: sourceRange.start, end: sourceRange.end })) === null || _c === void 0 ? void 0 : _c.start;
    ...
    function addMapping(gen, mapping) {
        ...
        const templateStart = (_a = htmlToTemplate(mapping.sourceRange)) === null || _a === void 0 ? void 0 : _a.start;
        ...
        if (mapping.additional) {
            ...
            for (const other of mapping.additional) {
                let otherTemplateStart = (_b = htmlToTemplate(other.sourceRange)) === null || _b === void 0 ? void 0 : _b.start;
