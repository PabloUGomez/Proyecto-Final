...
function createLanguageServiceContext(ts, host, extraPlugins = [], exts = ['.vue', '.md', '.html']) {
    ...
    function update() {
        ...
        for (const vueFile of documentRegistry.getAll()) {
            if (!vueFileNames.has(vueFile.fileName) && !((_b = host.fileExists) === null || _b === void 0 ? void 0 : _b.call(host, vueFile.fileName))) {
                // delete
                ...
                if (vueFile.text !== (newSnapshot === null || newSnapshot === void 0 ? void 0 : newSnapshot.getText(0, newSnapshot.getLength()))) {
        ...
        for (const tsFileVersion of tsFileVersions) {
            if (!vueFileNames.has(tsFileVersion[0]) && !((_c = host.fileExists) === null || _c === void 0 ? void 0 : _c.call(host, tsFileVersion[0]))) {
                // delete
