...
const petite_vue_script_1 = require("./plugins/petite-vue-script");
...
function createSourceFile(fileName, _content, compilerOptions, vueCompilerOptions, ts, extraPlugins = []) {
    ...
    const templateCodeGens = (0, reactivity_1.computed)(() => {
        ...
        return templateGen.generate(ts, {
            ...
            experimentalAllowTypeNarrowingInInlineHandlers: (_c = vueCompilerOptions.experimentalAllowTypeNarrowingInInlineHandlers) !== null && _c !== void 0 ? _c : false,
    ...
    const plugins = [
        ...
        (0, vue_typescript_template_1.default)(ts, cssModuleClasses, cssScopedClasses, templateCodeGens, cssVars, scriptSetupRanges, scriptLang, vueCompilerOptions, !!vueCompilerOptions.experimentalDisableTemplateSupport || ((_a = compilerOptions.jsx) !== null && _a !== void 0 ? _a : ts.JsxEmit.Preserve) !== ts.JsxEmit.Preserve, fileName.endsWith('.html') // petite-vue
        ),
    ];
    // computeds
    ...
    return {
        ...
        getCompiledVue: (0, untrack_1.untrack)(() => file2VueSourceMap.value),
        ...
        getScriptFileName: (0, untrack_1.untrack)(() => fileName.endsWith('.html') ? fileName + '.__VLS_script.' + scriptLang.value : fileName + '.' + scriptLang.value),
        ...
        isJsxMissing: () => { var _a; return !vueCompilerOptions.experimentalDisableTemplateSupport && ((_a = compilerOptions.jsx) !== null && _a !== void 0 ? _a : ts.JsxEmit.Preserve) !== ts.JsxEmit.Preserve; },
